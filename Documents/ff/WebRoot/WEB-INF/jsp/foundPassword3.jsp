...
<html>
	...
	<body style="overflow-x: hidden; overflow-y: auto;">
		...
		<header class="top clearfix">
			<!--Start top_logo-->
			<div class="top_logo">
				<a href="../index.html" title="缘来再此交友网">缘来再此交友网</a>
			</div>
			<!--End top_logo-->
			...
			<article class="data_inner_container container-fluid clearfix">
				...
				<div class="container-fluid col-xs-12 col-sm-12 col-md-12 col-lg-12 found_password_form">
					...
					<form class="thumbnail col-xs-12 col-sm-12 col-md-5 col-lg-4">
						<h3 class="text-center text-muted">恭喜您，重置密码成功!</h3>
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<a href="../html/login.jsp" type="button" class="btn btn-info btn-lg col-xs-12 col-sm-12 col-md-12 col-lg-12" id="register_form_submit">立即登录</a>
						</div>
					</form>
					<!-- 表单三:显示重置结果 -->	
				</div>
